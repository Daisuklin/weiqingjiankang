...
//
  ...
  render() {
    ...
    if (data.advPosition && data.advPosition.advList && data.advPosition.advList.length > 0) {
      ...
      advContent = <a href={data.advPosition.advList[0].advUrl} style={{width:'100%',height:'2rem'}}>
          <Img src={data.advPosition.advList[0].resUrl} style={{width:'100%',height:'2rem',borderRadius:'0.1rem'}}/>
      </a>;
        imgAdvContent1 = <a href={data.advPosition.advList[1].advUrl} style={{width:'100%',height:'4rem'}}>
            <Img src={data.advPosition.advList[1].resUrl} style={{width:'100%',height:'4rem',borderRadius:'0.1rem'}}/>
        </a>;
        imgAdvContent2 = <a href={data.advPosition.advList[2].advUrl} style={{width:'100%',height:'1.6rem'}}>
    ...
    return <List style={{marginBottom:'0rem'}}>
        <Flex justify='between'>
            <div style={{width:'100%',textAlign:'center',height:'.89rem'}}><Img src={data.floorImg} style={{width:'100%',height:'.89rem'}}/></div>
        </Flex>
      <List.Item className="homeFloorGoods_item">
          ...
          <Flex justify='between' style={{padding:'0.1rem 0.1rem'}}>
              <Flex.Item>
                  {advContent}
              </Flex.Item>
          </Flex>
