...
class AccountSafe extends Component {
  ...
  render() {
    return <div className="wx-accountSafe">
      <List>
        {/*<Item arrow="horizontal" onClick={this.gotoUpdatePassword} style={{padding:'0px 0.26rem'}}>修改密码</Item>*/}
        <Item arrow="horizontal" onClick={this.payPasswordSet} style={{padding:'0px 0.26rem'}}>支付密码设置</Item>
      </List>
    </div>
  }
}
