...
const routesConfig = (<Route path="/" component={App}>
  ...
  <Route path='/spellOrder/:cartId' component={spellOrder} title='确认订单'/>
  <Route path='/orderSuccess/:cartId' component={orderSuccess} title='完成订单'/>
  <Route path='/viewLogistics/:cartId' component={viewLogistics} title='查看物流'/>
</Route>)
