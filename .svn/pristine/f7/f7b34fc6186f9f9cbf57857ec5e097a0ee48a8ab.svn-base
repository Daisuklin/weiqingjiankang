      ...
      <div className='wx-cart-list-bar'>
        <Flex>
          ...
          </Flex.Item>
          {
            editStatus == 0 ? [
              <Flex.Item key={1}>
                <div onClick={()=>console.log(cartList)} style={{minWidth:'100px',height:'0.9rem',lineHeight:'0.9rem',fontSise:'0.28rem',color:'#666'}}>合计: ¥{this.state.goodsTotalPrice}</div>
              ...
              <Flex.Item key={2} style={{
                ...
                <Button type='primary' size='small' inline onClick={this.gotoBuy} style={{
                  height:'100%',width:'100%',background:'#e3536c',fontSize:'0.28rem',borderRadius:'0px',lineHeight:'0.9rem'
                }}>去结算</Button>
              </Flex.Item>    
             ] : [
              <Flex.Item key={1}>
