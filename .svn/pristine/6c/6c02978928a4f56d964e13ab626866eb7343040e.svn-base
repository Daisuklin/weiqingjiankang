        ...
        return (
            <div className="wx-orderDetail">
                <List className="order-list-content">
                    <Item extra={<div
                        style={{fontSize: '0.26rem'}}>{this.getStatusShowText(orderDetail.orderState)}</div>}
                          multipleLine>
                    ...
                    <Flex style={{width: '100%'}}>
                        <Flex.Item style={{flex: 1, textAlign: 'right'}}>
                            {orderDetail.orderState != 10 ? <div>
                                < Button type='primary' inline className="btn_gotoSub" onClick={this.cancelOrder}
                                         style={{
                                             height: '0.6rem',
                                             lineHeight: '0.6rem',
                                             fontSize: '0.28rem',
                                ...
                                <div>
                                    ...
                                    <Button type='primary' inline className="btn_gotoSub" style={{
                                        ...
                                        padding: '0 0.1rem',
                                        width: '2rem', marginLeft: '0.2rem'
                                    }}  onClick={()=>this.gotoFriendPay()}>好友代付</Button>
