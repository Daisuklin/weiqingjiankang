  ...
  render() {
    ...
    return (<form className='wx-reg'>
      <List>
        ...
        <Item style={{padding:'0.2rem 0rem 0.2rem 0.3rem'}}>
          <Button type="primary" onClick={this.onSubmit} style={{background:'#5491d2',borderColor:'#5491d2',fontSize:'0.28rem'}}>修改密码</Button>
        </Item>
      </List>
    </form>);
  }
