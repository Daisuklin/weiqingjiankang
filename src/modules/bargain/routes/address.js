...
class Address extends Component {
  ...
  onSelectAddress = (address) => {
    ...
    this.props.router.replace(`/bargainPurchase/${this.props.barginOrder.bargainId}`)
  }
  ...
  render() {
    ...
    return <div className=''>
      <div className='wx-pointes-addresslist fix-scroll hastitle'>
        <div style={{marginBottom:'0.84rem'}}>
      {
        addressList.map(address => {
          return <List key={address.addressId} className="wx-addresslist-content">
            <Item multipleLine className="am-list-item1" onClick={()=>this.onSelectAddress(address)}>
