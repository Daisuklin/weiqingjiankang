        ...
        return (
            <div className="wx-orderDetail">
                <List className="order-list-content">
                    <Item extra={<div style={{fontSize:'0.26rem'}}>
                        {
                            orderDetail.lockState == 1 ? '退款申请中': <span>{this.getStatusShowText(orderDetail.orderState)}</span>
                    ...
                    <Flex style={{width: '100%'}}>
                        <Flex.Item  style={{flex: 1, textAlign: 'right'}}>
                            {orderDetail.orderState != 10 ? <div>
                                ...
                                {
                                    orderDetail.orderState == 0 ? <Button type='primary' inline  style={{
                                        height: '0.6rem',
                                        lineHeight: '0.6rem',
                                        fontSize: '0.28rem',
                                        color: '#999',
                                    ...
                                    }}>已取消订单</Button> : <Button type='primary' inline  style={{
                                        height: '0.6rem',
                                        lineHeight: '0.6rem',
                                        fontSize: '0.28rem',
                                        color: '#fff',
                                    ...
                                    {
                                        (orderDetail.lockState == 1 || orderDetail.orderState == 0) ? null : < Button type='primary' inline className="btn_gotoSub" onClick={()=>this.cancelOrder(orderDetail)} style={{
                                            height: '0.6rem',
                                            lineHeight: '0.6rem',
                                            fontSize: '0.28rem',
                                            color: '#999',
