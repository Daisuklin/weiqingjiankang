...
如果不能访问api
1.登录 http://192.169.1.190:8080/leimingtech-admin/
2.同一个浏览器访问 http://192.169.1.190:8080/leimingtech-admin/shopViewWhite/list
    IP白名单管理
    新增
